...
#### Note to self: Remove 'Point_ID', 'Interval_seconds' prior to publishing
...
def training_preprocess_sub(data_preprocessed):
    ...
    data_preprocessed = (
        data_preprocessed.groupby(['DateTime', 'TowerID', 'TagID', 'Antenna', 'Data_type', 'POINT_X', 'POINT_Y', 'Point_ID', 'Interval_seconds'])['Power']
    ...
    data_preprocessed = (
        data_preprocessed.pivot_table(
            index=['DateTime', 'TowerID', 'TagID', 'Data_type', 'POINT_X', 'POINT_Y', 'Point_ID', 'Interval_seconds'],
            columns='Antenna',
