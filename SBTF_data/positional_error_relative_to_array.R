...
error_dataset <- read_excel("combined_predictions_20240330.xlsx")

# Convert tower_group to a factor (categorical variable)
error_dataset$tower_group <- as.factor(error_dataset$tower_group)
...
ggsave("paper_results/Figures/model_comparison_20240401.jpeg", plot = plot_location, width = 110, height = 100, units = "mm", dpi = 300)
